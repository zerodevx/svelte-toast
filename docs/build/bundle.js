...
var app = (function () {
    ...
    function create_if_block_1(ctx) {
    	...
    	let current;
    	const switch_instance_spread_levels = [/*item*/ ctx[0].props];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			? get_spread_update(switch_instance_spread_levels, [get_spread_object(/*item*/ ctx[0].props)])
    			: {};
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 89, 2, 2142);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(progress_1, file$4, 92, 2, 2248);
